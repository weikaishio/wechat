...
*/
func ProfitSharing(clt *core.Client, req *ProfitSharingRequest) (resp *ProfitSharingResponse, err error) {
	m1 := RequestToMap(req)
	...
	m2, err := clt.PostXML(core.APIBaseURL()+"/secapi/pay/profitsharing", m1)
	if err != nil {
		return nil, err
	}

	resp = &ProfitSharingResponse{}
